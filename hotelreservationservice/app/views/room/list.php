...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/hotelreservationservice/Room/add" class="btn btn-primary">
                ...
                <tbody>
                    <?php foreach ($rooms as $room): ?>
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-info"><?= htmlspecialchars($room->room_type) ?></span>
                            </td>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="/hotelreservationservice/Room/show/<?= $room->id ?>" 
                                       class="btn btn-sm btn-outline-info" title="Xem chi tiết">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="/hotelreservationservice/Room/edit/<?= $room->id ?>" 
